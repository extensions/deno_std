...
impl Context {
  pub fn new(algorithm_name: &str) -> Result<Context, &'static str> {
    Ok(match algorithm_name {
      ...
      // "SHA-1-DC" => Sha1DC(Default::default()),
      ...
      "FNV32" => Fnv32(Default::default()),
      "FNV32A" => Fnv32A(Default::default()),
      "FNV64" => Fnv64(Default::default()),
      "FNV64A" => Fnv64A(Default::default()),
  ...
  pub fn input_block_length(&self) -> usize {
    ...
    match self {
      ...
      Fnv32(context) => static_block_length(&**context),
      Fnv32A(context) => static_block_length(&**context),
      Fnv64(context) => static_block_length(&**context),
      Fnv64A(context) => static_block_length(&**context),
  ...
  pub fn output_length(&self) -> usize {
    match self {
      ...
      // Sha1DC(context) => context.output_size(),
  ...
  pub fn reset(&mut self) {
    match self {
      ...
      // Sha1DC(context) => Reset::reset(&mut **context),
      ...
      Fnv32(context) => *context = Default::default(),
      Fnv32A(context) => *context = Default::default(),
      Fnv64(context) => *context = Default::default(),
      Fnv64A(context) => *context = Default::default(),
    };
  }
  ...
  pub fn update(&mut self, data: &[u8]) {
    match self {
      ...
      // Sha1DC(context) => Digest::update(&mut **context, data),
  ...
  pub fn digest_and_drop(
    ...
    Ok(match self {
      ...
      // Sha1DC(context) => context.finalize(),
  ...
  pub fn digest_and_reset(
    ...
    Ok(match self {
      ...
      // Sha1DC(context) => DynDigest::finalize_reset(context.as_mut()),
